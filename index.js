...
const port = 8000; // assigning port, so that I can try and test at this port,
const app = express(); 
...
app.use(session({
    ...
    store: MongoStore.create({
        mongoUrl: 'mongodb+srv://Somesh:12345@cluster0.uqjdt9h.mongodb.net/?retryWrites=true&w=majority',
        autoRemove: 'disabled'
    },
        (err) => {
